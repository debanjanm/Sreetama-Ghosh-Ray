...
## Construct-to-Item Map

| Construct | Questions | Main evidence basis | Adaptation decision |
| --- | ---: | --- | --- |
| Hybrid Learning | 5–11 | Sosnova et al. (2025); Kim (2022); Han and Ellis (2020); Kumar and Pande (2017); Mulaudzi (2021) | Measures the integration of modes, platform access, material availability, and ability to revisit learning. It does not assess an LMS as a technology product. |
| Trainer Competence | 12–17 | Kim (2022); Ansari et al. (2023); Mulaudzi (2021) | Measures subject knowledge, clarity, digital facilitation, connection of activities, participation support, and feedback. |
| Learner Engagement | 18–23 | Schaufeli, Bakker and Salanova (2006); Kim (2022); Mulaudzi (2021) | Measures attention, effort, participation, involvement, clarification-seeking, and interest during the selected programme. It does not measure general work engagement. |
| Training Effectiveness | 24–30 | Bahl, Kiran and Sharma (2024); Kim (2022); Aziz (2015); Kirkpatrick (1994); Baldwin and Ford (1988); Blume et al. (2010) | Measures employee-reported learning, work relevance, capability, application, task support, and confidence. Bahl supports the Indian banking evaluation context; the items do not ask employees to judge Bank-wide results. |

## Item-Development Rules

- Each item uses first-person, plain workplace language and refers to the same selected programme.
- Items about programme delivery belong to Hybrid Learning; items about the trainer belong to Trainer Competence.
- Engagement items describe employee involvement during training; they do not repeat the trainer or platform items.
