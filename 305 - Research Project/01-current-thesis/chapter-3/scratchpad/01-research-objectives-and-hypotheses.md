...
**Added below (department convention requires H0 stated first, always negating with "no significant [relationship/effect]" — see [the MSSW writing style guide](../../../03-reference-material/writing-guidance/mssw-writing-style-guide.md) Part 1 #4): no version bump, this completes standard reporting convention without changing any tested relationship.**
