...
Model-Alpha has **three** mediators in sequence, not one — Learner Engagement, Training Effectiveness, and Knowledge Retention each sit between two other variables and mediate that relationship (see [01](01-research-objectives-and-hypotheses.md) H5a-c):
...
**Cross-references:** [01-base-questionnaire-and-calculation.md](01-base-questionnaire-and-calculation.md) · [02-refined-questionnaire.md](02-refined-questionnaire.md) · [04-literature-summary.md](../chapter-2/04-literature-summary.md) · [01-research-objectives-and-hypotheses.md](01-research-objectives-and-hypotheses.md) · [SEQUENCE.md](../../../90-internal-archive/history/SEQUENCE.md)
