...
**v0 → v1 change log:** v0 (still on disk, [chapter-3/objectives-and-hypotheses/version-0/01](01-research-objectives-and-hypotheses.md)) had no Trainer Competence. This version adds it as a direct antecedent to Engagement (new H1b), instrument gains 8 items (TC1-8, see [03-model-alpha-questionnaire.md v1](01-model-alpha-questionnaire.md)).
...
**Added below (department convention requires H0 stated first, always negating with "no significant [relationship/effect]" — see [the MSSW writing style guide](../../../07-reference-material/writing-guidance/mssw-writing-style-guide.md) Part 1 #4): no version bump, this completes standard reporting convention without changing any tested relationship.**

| # | Null hypothesis (H0) | Alternative hypothesis | Tested via |
|---|---|---|---|
| H1 | Hybrid Learning has no significant effect on Learner Engagement. | Hybrid Learning has a significant positive effect on Learner Engagement. | Regression Model 1, [01 v1](01-model-alpha-questionnaire.md) |
...
**Cross-references:** [01-initial-analysis.md](../chapter-1/02-initial-analysis.md) · [02-guide-suggestion.md](../chapter-1/03-guide-suggestion.md) · [03-literature-matrix.md](../chapter-2/03-literature-matrix.md) · [06-gap.md](../chapter-2/06-gap.md) · [08-base-paper.md](../chapter-2/08-base-paper.md) · [03-model-alpha-questionnaire.md v1](01-model-alpha-questionnaire.md) · [PLAN.md](../../../90-internal-archive/project-planning/PLAN.md)
