...
Full explanation with the "machine" analogy already in [04-atomic-concepts.md](../../atomic-concepts/v1-chapter-1-atomic-concepts.md) sec 12 — this entry is the quick-reference version.
...
**In your model:** you don't currently have one. Organizational/Supervisor Support was considered as a moderator (it moderates Engagement→Effectiveness in your base paper, Saroj et al. 2026) but was excluded — that's the rejected Model-Beta scope ([07-model-beta-chain-check.md](../chapter-2/07-model-beta-chain-check.md)).

**Mediator vs moderator, one line each:** mediator = *mechanism* (why/how); moderator = *condition* (when/for whom). Full contrast already in [04-atomic-concepts.md](../../atomic-concepts/v1-chapter-1-atomic-concepts.md) sec 12.
...
**In your model:** age, years of experience, job level, training frequency (Section A of [01-model-alpha-questionnaire.md](../chapter-3/01-model-alpha-questionnaire.md)) — used for the t-test/ANOVA subgroup comparisons (H6-H8), not the core chain.
...
- **Construct validity** — does it actually measure the underlying theoretical construct, not something else? Harder to establish with a small master's-level study; citing your items back to theory (per [04-literature-summary.md](../chapter-2/04-literature-summary.md)) is your main defense here.
...
### Pilot Test
A small trial run of your instrument (department norm: 20-30 respondents, per [05-past-dissertation-summary.md](../chapter-2/05-past-dissertation-summary.md) sec 9.1) before full data collection — used to check reliability (Cronbach's alpha per section) and catch confusing items before they cost you real respondents.
...
**Cross-references:** [03-guide-suggestion.md](03-guide-suggestion.md) · [04-atomic-concepts.md](../../atomic-concepts/v1-chapter-1-atomic-concepts.md) (full mediator/moderator explanation) · [01-base-questionnaire-and-calculation.md](../chapter-3/01-base-questionnaire-and-calculation.md) (stats basics already covered) · [04-literature-summary.md](../chapter-2/04-literature-summary.md) · [05-past-dissertation-summary.md](../chapter-2/05-past-dissertation-summary.md) · [01-research-objectives-and-hypotheses.md v1](../chapter-3/01-research-objectives-and-hypotheses.md) · [01-model-alpha-questionnaire.md v1](../chapter-3/01-model-alpha-questionnaire.md) · [PLAN.md](../../../90-internal-archive/project-planning/PLAN.md)
